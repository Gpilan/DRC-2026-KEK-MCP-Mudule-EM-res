...
int main(int argc, char *argv[]) {
    ...
    int C_first = 135; // Module integration range
    int C_last = 270;  // Module integration range
    ...
    int C_last_T5 = 285.; // integration range for T5
    int S_first_T5 = 160.;   // integration range for T5
    int S_last_T5 = 330.; // integration range for T5
    ...
    TFile* WC_rootFile = new TFile("./WC_mean/WC_mean.root");
    TH1F* hist_NIM_WCX = (TH1F*)WC_rootFile->Get("NIM_WCX");
    TH1F* hist_NIM_WCY = (TH1F*)WC_rootFile->Get("NIM_WCY");
    float WC_X_ref = 0.;
    float WC_Y_ref = 0.;
    ...
    float scaleFactor_C = 0.83798883;
    float scaleFactor_S = 0.85738783;
    
    float calib_T1C = 0.000079813464;
    float calib_T2C = 0.000080576581;
    float calib_T3C = 0.000081329919;
    float calib_T4C = 0.000083729778;
    float calib_T5C = 0.000076710145;
    float calib_T6C = 0.000082426966;
    float calib_T7C = 0.000079831516;
    float calib_T8C = 0.000073961011;
    float calib_T9C = 0.000076007847;

    float calib_T1S = 0.000036307367;
    float calib_T2S = 0.000038216058;
    float calib_T3S = 0.000036278234;
    float calib_T4S = 0.000035384910;
    float calib_T5S = 0.000036311445;
    float calib_T6S = 0.000035935613;
    float calib_T7S = 0.000034118810;
    float calib_T8S = 0.000035142399;
    float calib_T9S = 0.000036669215;
